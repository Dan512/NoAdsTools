// convert-image/js/zip.js — lazy JSZip loader. 0 KB until "Download all
// (ZIP)" is clicked; script-injected from /vendor/jszip/ (own origin). Same
// pattern as compress-images/js/zip.js, find-duplicate-photos/js/zip.js,
// remove-exif/js/zip.js, and heic-to-jpg/js/zip.js.
let cached = null;
