...
| `libheif.wasm` (~1.0 MB) | `libheif-wasm/libheif.wasm` | The compiled libheif WebAssembly module. Fetched on demand (see `shared/heic-loader.js`). |
...
loader code (`shared/heic-loader.js`).

## Runtime discipline

Loaded lazily by `shared/heic-loader.js` — nothing is fetched until
