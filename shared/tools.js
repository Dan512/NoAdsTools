...
export const TOOLS = Object.freeze([
  ...
  { slug: 'image-to-pdf', title: 'Image to PDF', category: 'pdf',
    ...
    status: 'live' },
  { slug: 'merge-pdf', title: 'Merge PDF', category: 'pdf',
    blurb: 'Combine PDF files in any order — nothing uploaded.',
    status: 'live' },
  { slug: 'split-pdf', title: 'Split PDF', category: 'pdf',
    blurb: 'Extract pages or split a PDF into pieces — nothing uploaded.',
    status: 'live' },
  { slug: 'watermark-pdf', title: 'Watermark PDF', category: 'pdf',
    blurb: 'Add a text or logo watermark to a PDF — nothing uploaded.',
    status: 'live' },
  { slug: 'sign-pdf', title: 'Sign PDF', category: 'pdf',
    blurb: 'Draw or type a signature and place it on a PDF — nothing uploaded.',
    status: 'live' },
  { slug: 'pdf-to-jpg', title: 'PDF to JPG', category: 'pdf',
    blurb: 'Convert PDF pages to JPG or PNG images — nothing uploaded.',
    status: 'live' },
