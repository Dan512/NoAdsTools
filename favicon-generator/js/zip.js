// favicon-generator/js/zip.js — lazy JSZip loader. 0 KB until "Download
// package" is clicked; the UMD bundle is script-injected from /vendor/jszip/
// (own origin). Same pattern as heic-to-jpg/js/zip.js.
let cached = null;
